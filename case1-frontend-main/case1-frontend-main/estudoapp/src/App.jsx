  ...
  async function createContent(event) {
    try {
      ...
      await ContentsApi().createContent(
        req.nome.value, req.genero.value, Number(req.idade.value)
      ).then(data => {
        return data.json()
      }).then(res => {
  ...
  async function updateContent(event) {
    try {
      ...
      await ContentsApi().updateContent(
        selectedContent.id, req.nome.value, req.genero.value, Number(req.idade.value)
      )
